...
//        private HashSet<string> _subscriptionsCache = new HashSet<string>();
...
//                        //if (_subscriptionsCache.Count > 0) {
//                        //    _logger.LogInformation($"Restoring {_subscriptionsCache.Count} subscriptions.");

//                        //    foreach (var subscription in _subscriptionsCache) {
//                        //        await SubscribeToTopicAsync(subscription);
//                        //    }
//                        //}
